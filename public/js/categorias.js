...
$(document).ready(function () {
  ...
  var formCategorias = $("#form-categorias");
  ...
  tablaCategorias = $("#tabla_categorias").DataTable({
    ...
    "columnDefs": [{
      ...
      "render": function render(data, type, row) {
        return "<div class='text-center'><button data-edit_categoria='".concat(row.id, "' class='btn btn-primary btn-sm'><i class='fas fa-edit'></i></button><button data-descripcion='").concat(row.descripcion, "' data-delete_categoria='").concat(row.id, "' class='btn btn-danger btn-sm ml-1'><i class='fas fa-trash'></i></button></div>");
      }
    }]
  ...
  $(document).on('click', 'button[data-delete_categoria]', function () {
    ...
    Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["sweetDelete"])("¿Eliminar categoría?", "\xA1Se eliminara la categor\xEDa <b>".concat(descripcion, "</b>!"), function () {
...
/***/ 2:
/*!******************************************!*\
  !*** multi ./resources/js/categorias.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
