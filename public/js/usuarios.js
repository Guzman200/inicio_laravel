...
$(document).ready(function () {
  ...
  var tablaUsuarios; // Inicializamos la tabla usuarios
  ...
  $("button[data-add_usuario]").off().click(function () {
    Livewire.emit('agregar');
  }); // Editar un usuarios

  $(document).on('click', 'a[data-edit_usuario]', function () {
    var id = $(this).data("edit_usuario");
    Livewire.emit('editar', id);
  }); /// Eliminar usuario

  $(document).on('click', 'a[data-delete_usuario]', function () {
    var id = $(this).data("delete_usuario");
    var nombre = $(this).data("nombres");
    Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["sweetDelete"])("¿Eliminar usuario?", "\xA1Se eliminara el usuario <b>".concat(nombre, "</b>!"), function () {
      Livewire.emit('eliminar', id);
    });
  }); // Cambiar estatus de usuario

  $(document).on('click', 'a[data-desactivar_usuario]', function () {
    var id = $(this).data("desactivar_usuario");
    var nombre = $(this).data("nombres");
    Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["sweetDelete"])("¿Cambiar estatus?", "\xA1Se cambiara el estatus del usuario <b>".concat(nombre, "</b>!"), function () {
