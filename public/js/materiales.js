...
$(document).ready(function () {
  ...
  var tablaMateriales; // Inicializamos la tabla transportadores
  ...
  tablaMateriales = $("#tabla_materiales").DataTable({
    ...
    "columnDefs": [{
      ...
      "render": function render(data, type, row) {
        return " \n                    <button class=\"btn btn-sm\" type=\"button\" \n                            data-toggle=\"dropdown\"  aria-expanded=\"false\">\n                            <i class=\"fas fa-ellipsis-v\"></i>\n                    </button>\n                    <div class=\"dropdown-menu dropdown-menu-right\">\n                        <a class=\"dropdown-item\" href=\"#\" data-edit_material='".concat(row.id, "'>Editar</a>\n                        <a class=\"dropdown-item\" href=\"#\" data-delete_material='").concat(row.id, "' data-nombre='").concat(row.nombre, "'>Eliminar</a>\n                    </div>");
      }
    }]
  }); // Agregar un nuevo material

  $("button[data-add_material]").off().click(function () {
    Livewire.emit('agregar');
  }); // Editar un material

  $(document).on('click', 'a[data-edit_material]', function () {
    var id = $(this).data("edit_material");
    Livewire.emit('editar', id);
  }); // Eliminar material

  $(document).on('click', 'a[data-delete_material]', function () {
    var id = $(this).data("delete_material");
    var nombre = $(this).data("nombre");
    Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["sweetDelete"])("¿Eliminar material?", "\xA1Se eliminara el material <b>".concat(nombre, "</b>!"), function () {
...
/***/ 3:
/*!******************************************!*\
  !*** multi ./resources/js/materiales.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
