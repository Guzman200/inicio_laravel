    ...
    <form autocomplete="off" id="form-usuarios">
        ...
        <div class="form-group">
            <label class="has-float-label">
                <input wire:model.defer="num_identificacion" type="email"
                    class="form-control hide-placeholder @error('num_identificacion') is-invalid @enderror"
                    placeholder="Identificación">
                <span>No. Indentificación</span>
            </label>
        ...
        <div class="form-group">
            <label class="has-float-label">
                <input wire:model.defer="email" type="email"
                    class="form-control hide-placeholder @error('email') is-invalid @enderror" placeholder="Email">
                <span>Email</span>
            </label>
            @error('email')
                <div class="invalid-feedback text-right d-block">{{ $message }}</div>
        ...
        {{-- Contraseña --}}
        <div class="form-group @if (!is_null($usuario_id)) d-none @endif">
            <label class="has-float-label">
                <input  wire:model.defer="password" type="password" 
                        class="form-control hide-placeholder @error('password') is-invalid @enderror" name="password"
        ...
        <div class="form-group @if (!is_null($usuario_id)) d-none @endif">
            <label class="has-float-label">
                <input  wire:model.defer="password_confirmation" type="password" 
                        ...
                        name="password_confirmation" required autocomplete="new-password" placeholder="Confirmación">
